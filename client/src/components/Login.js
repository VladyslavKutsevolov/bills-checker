  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <button
        ...
        className="text-white shadow-2xl -mt-16 w-72 bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center hover:text-gray-900 dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
      >
        <svg
          fill="none"
          height="35"
